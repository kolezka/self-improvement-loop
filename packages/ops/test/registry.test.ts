// Registry self-checks and the full 32-op tier/gate table. Every test that
...
// real 32 ops registered by the side-effecting "../src/index.ts" import.
...
// Name -> [tier, gate]: the 30 ops of sil/ops.py plus llm.use and health.build.
